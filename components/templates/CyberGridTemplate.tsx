        ...
        >
            <div>
                ...
                {summary.professionalSummary && (
                    <section className="border border-slate-300 p-5 bg-white mb-6">
                    ...
                    <div className="col-span-8 space-y-5">
                        ...
                        {experience.length > 0 && (
                            <section className="border border-slate-300 bg-white p-5">
                                <div className="flex justify-between items-center border-b border-dashed border-slate-200 pb-2 mb-4">
                                ...
                                <div className="space-y-5">
                                    {experience.map(exp => (
                                        <div key={exp.id} className="border-l border-teal-600/30 pl-3">
                    ...
                    <div className="col-span-4 space-y-5">
                        ...
                        {education.length > 0 && (
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-4">
                                    {education.map(edu => (
                                        <div key={edu.id} className="text-[10px] font-sans">
                            ...
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-3 font-sans text-[10px]">
                                    {certifications.map(cert => (
                                        <div key={cert.id} className="border-l border-teal-600 pl-2">
                        ...
                        {visibleSections.includes('languages') && languages.length > 0 && (
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-2 text-[10px] font-mono font-bold">
                                    {languages.map(lang => (
                                        <div key={lang.id} className="flex justify-between border-b border-slate-100 py-1">
                        ...
                        {visibleSections.includes('awards') && awards.length > 0 && (
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-2 text-[10px]">
                                    {awards.map(aw => (
                                        <div key={aw.id} className="border-l border-slate-300 pl-2">
                        ...
                        {visibleSections.includes('trainings') && trainings.length > 0 && (
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-2 text-[9px] font-mono">
                                    {trainings.map(t => (
                                        <div key={t.id} className="border-l border-dashed border-teal-500 pl-2">
                        ...
                        {visibleSections.includes('volunteer') && volunteer.length > 0 && (
                            <section className="border border-slate-300 bg-white p-4">
                                ...
                                <div className="space-y-2 text-[9px] font-sans">
                                    {volunteer.map(v => (
                                        <div key={v.id} className="border-l border-[#0D9488] pl-2">
...
export default CyberGridTemplate;
