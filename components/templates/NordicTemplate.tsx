            ...
            <div>
                ...
                <main className="grid grid-cols-12 gap-8 p-10">
                        ...
                        {experience.length > 0 && (
                            <section>
                                ...
                                <div className="space-y-6">
                                    {experience.map(exp => (
                                        <div key={exp.id} className="relative pl-4 border-l border-stone-200">
                        ...
                        {visibleSections.includes('projects') && projects.length > 0 && (
                            <section>
                                ...
                                <div className="space-y-5">
                                    {projects.map(proj => (
                                        <div key={proj.id} className="relative pl-4 border-l border-stone-100">
                    ...
                    <div className="col-span-5 space-y-6">
                        ...
                        {skills.length > 0 && (
                            <section className="p-4 rounded-xl border border-stone-200" style={{ backgroundColor: lightSage }}>
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-3" style={{ color: pineColor }}>
                                    Core Qualifiers
                                </h3>
                        ...
                        {/* Education block */}
                        {education.length > 0 && (
                            <section className="p-4 rounded-xl border border-stone-100 bg-white">
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-3" style={{ color: pineColor }}>
                                    Academic Degrees
                                </h3>
                                <div className="space-y-4">
                                    {education.map(edu => (
                                        <div key={edu.id} className="text-[11px] border-b last:border-0 border-stone-150 pb-3 last:pb-0">
                        ...
                        {visibleSections.includes('certifications') && certifications.length > 0 && (
                            <section className="p-4 rounded-xl border border-stone-200/55" style={{ backgroundColor: lightSage }}>
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-2" style={{ color: pineColor }}>
                                    Credentials
                                </h3>
                                <ul className="space-y-2 text-[10px]">
                                    {certifications.map(cert => (
                                        <li key={cert.id} className="flex justify-between items-baseline font-medium">
                        ...
                        {visibleSections.includes('publications') && publications.length > 0 && (
                            <section className="p-4 rounded-xl border border-stone-250 bg-[#FCFAF5]">
                                <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-2" style={{ color: pineColor }}>
                                    Publications
                                </h3>
                                <ul className="space-y-2 text-[10px]">
                                    {publications.map(pub => (
                                        <li key={pub.id} className="flex flex-col">
