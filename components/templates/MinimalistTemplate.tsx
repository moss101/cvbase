...
const MinimalistTemplate: React.FC<ResumePreviewProps> = ({ formData, isCardPreview, visibleSections, settings }) => {
    ...
    return (
        <div id={isCardPreview ? undefined : "resume-preview-minimalist"} className={`w-[794px] min-h-[1123px] h-auto bg-white text-black p-12 ${fontSize} leading-normal`} style={{ fontFamily: settings?.fontFamily || 'Arial, sans-serif' }}>
            ...
            {experience.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Work Experience</h2>
            ...
            {visibleSections.includes('projects') && projects.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Projects</h2>
            ...
            {education.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Education</h2>
            ...
            {skills.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Skills</h2>
                    <p>{skills.join(', ')}</p>
                </section>
            )}
            ...
            {visibleSections.includes('certifications') && certifications.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Certifications</h2>
            ...
            {visibleSections.includes('awards') && awards && awards.length > 0 && (
                <section className="mb-6">
                     <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Awards</h2>
                     <ul className="list-disc list-inside">
                        {awards.map(award => (
                            <li key={award.id}>
            ...
            {visibleSections.includes('trainings') && trainings && trainings.length > 0 && (
                <section className="mb-6">
                     <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Training & Courses</h2>
            ...
            {visibleSections.includes('publications') && publications && publications.length > 0 && (
                <section className="mb-6">
                     <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Publications</h2>
                     <div className="space-y-3">
            ...
            {visibleSections.includes('volunteer') && volunteer && volunteer.length > 0 && (
                <section className="mb-6">
                     <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Volunteering</h2>
                     <div className="space-y-3">
                        {volunteer.map(vol => (
                            <div key={vol.id}>
                                <div className="flex justify-between font-bold">
            ...
            {visibleSections.includes('custom') && custom && custom.length > 0 && (
                <section className="mb-6">
                     <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Additional Activities</h2>
                     <div className="space-y-3">
                        {custom.map(item => (
                            <div key={item.id}>
                                <div className="flex justify-between font-bold">
            ...
            {visibleSections.includes('languages') && languages.length > 0 && (
                <section className="mb-6">
                    <h2 className="text-sm font-bold uppercase border-b mb-3 pb-1" style={{ borderColor: '#e5e7eb', color: accentColor }}>Languages</h2>
                    <p>
