        ...
        switch (id) {
            case 'summary':
                return summary.professionalSummary ? (
                    <section key="summary" data-section="summary">
                         <h2 className="text-2xl font-black uppercase mb-4 break-after-avoid">Profile</h2>
            ...
            case 'experience':
                return experience.length > 0 ? (
                    <section key="experience" data-section="experience">
                        <h2 className="text-2xl font-black uppercase mb-6 break-after-avoid">Experience</h2>
            ...
            case 'education':
                return education.length > 0 ? (
                    <section key="education" data-section="education">
                        <h2 className="text-xl font-black uppercase mb-4 break-after-avoid">Education</h2>
            ...
            case 'skills':
                return skills.length > 0 ? (
                    <section key="skills" data-section="skills" className="bg-gray-50 p-6 rounded-2xl">
                        <h2 className="text-xl font-black uppercase mb-4 text-center break-after-avoid">Skills</h2>
            ...
            case 'projects':
                return projects.length > 0 ? (
                    <section key="projects" data-section="projects">
                         <h2 className="text-2xl font-black uppercase mb-6 break-after-avoid">Key Projects</h2>
            ...
            case 'certifications':
                return certifications.length > 0 ? (
                    <section key="certifications" data-section="certifications">
                         <h2 className="text-xl font-black uppercase mb-4 break-after-avoid">Certifications</h2>
                         <ul className="space-y-2">
                            {certifications.map((cert, i) => (
                                <li key={i} className="flex items-center gap-2 text-xs font-medium text-gray-600 break-inside-avoid">
                                    <Award aria-hidden="true" className="w-[1em] h-[1em] shrink-0 inline-block align-[-0.125em] text-lg" style={{ color: primaryColor }} />
                                    {cert.name}
                                </li>
                            ))}
                         </ul>
            ...
            case 'languages':
                return languages.length > 0 ? (
                    <section key="languages" data-section="languages">
                         <h2 className="text-xl font-black uppercase mb-4 break-after-avoid">Languages</h2>
                         <ul className="space-y-2">
                            {languages.map((lang, i) => (
                                <li key={i} className="flex justify-between text-xs font-medium text-gray-600 break-inside-avoid">
            ...
            case 'awards':
                return awards && awards.length > 0 ? (
                    <section key="awards" data-section="awards">
                         <h2 className="text-xl font-black uppercase mb-4 break-after-avoid">Awards</h2>
            ...
            case 'trainings':
                return trainings && trainings.length > 0 ? (
                    <section key="trainings" data-section="trainings">
                         <h2 className="text-xl font-black uppercase mb-4 break-after-avoid">Trainings</h2>
                         <div className="space-y-2 border-l-4 pl-4" style={{ borderColor: primaryColor }}>
            ...
            case 'publications':
                return publications && publications.length > 0 ? (
                    <section key="publications" data-section="publications">
                         <h2 className="text-2xl font-black uppercase mb-6 break-after-avoid">Publications</h2>
            ...
            case 'volunteer':
                return volunteer && volunteer.length > 0 ? (
                    <section key="volunteer" data-section="volunteer">
                         <h2 className="text-2xl font-black uppercase mb-6 break-after-avoid">Volunteering</h2>
                         <div className="space-y-4">
                            {volunteer.map(item => (
                                <div className="break-inside-avoid" key={item.id}>
            ...
            case 'custom':
                return custom && custom.length > 0 ? (
                    <section key="custom" data-section="custom">
                         <h2 className="text-2xl font-black uppercase mb-6 break-after-avoid">Additional</h2>
                         <div className="space-y-4">
                            {custom.map(item => (
                                <div className="break-inside-avoid" key={item.id}>
                                    <h3 className="text-base font-bold text-gray-900">{item.title}</h3>
        ...
        <div id={isCardPreview ? undefined : "resume-preview-swiss"} className={`w-[794px] min-h-[1123px] h-auto bg-white ${fontSize} p-10 text-gray-800`} style={{ fontFamily: settings?.fontFamily || 'Arial, sans-serif' }}>
            ...
            <div className="grid grid-cols-12 gap-10">
                ...
                <div className="col-span-5 space-y-10 pt-2">
                    {renderRun(['skills', 'education', 'certifications', 'languages', 'awards', 'trainings'])}
                </div>
            </div>
        </div>
    );
...
export default React.memo(SwissTemplate);
