        ...
        <div id={isCardPreview ? undefined : "resume-preview-harvard"} className={`w-[794px] min-h-[1123px] h-auto bg-white ${fontSize} flex flex-col p-12 text-gray-800`} style={{ fontFamily: settings?.fontFamily || 'Arial, sans-serif' }}>
            ...
            <main className="space-y-8">
                 {summary.professionalSummary && (
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Executive Summary</h2>
                        <div className="text-xs leading-relaxed text-gray-700 text-justify" dangerouslySetInnerHTML={{ __html: summary.professionalSummary }} />
                    </section>
                 )}

                {education.length > 0 && (
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Education</h2>
                ...
                {experience.length > 0 && (
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Professional Experience</h2>
                            ...
                            {experience.map(exp => (
                                <div key={exp.id} className="grid grid-cols-4 gap-4">
                                    ...
                                    <div className="col-span-3">
                                        ...
                                        <div className="text-xs leading-relaxed text-gray-700 space-y-1" dangerouslySetInnerHTML={{ __html: exp.description }} />
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                {visibleSections.includes('projects') && projects.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Projects</h2>
                        <div className="space-y-4">
                            {projects.map(item => (
                                <div key={item.id} className="grid grid-cols-4 gap-4">
                                    ...
                                    <div className="col-span-3">
                                        ...
                                        <div className="text-xs leading-relaxed text-gray-700 space-y-1" dangerouslySetInnerHTML={{ __html: item.description }} />
                                    </div>
                                </div>
                            ))}
                        </div>
                 ...
                 {visibleSections.includes('publications') && publications && publications.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Publications</h2>
                        <div className="space-y-4">
                ...
                {visibleSections.includes('trainings') && trainings && trainings.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Training</h2>
                        <div className="space-y-4">
                            {trainings.map(item => (
                                <div key={item.id} className="grid grid-cols-4 gap-4">
                                    <div className="col-span-1 text-right">
                ...
                {visibleSections.includes('volunteer') && volunteer && volunteer.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Volunteering</h2>
                        <div className="space-y-4">
                            {volunteer.map(item => (
                                <div key={item.id} className="grid grid-cols-4 gap-4">
                                    <div className="col-span-1 text-right">
                                    ...
                                    <div className="col-span-3">
                                        ...
                                        {item.description && <div className="text-xs leading-relaxed text-gray-700 space-y-1" dangerouslySetInnerHTML={{ __html: item.description }} />}
                                    </div>
                                </div>
                            ))}
                        </div>
                 ...
                 {visibleSections.includes('custom') && custom && custom.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Additional Activities</h2>
                        <div className="space-y-4">
                            {custom.map(item => (
                                <div key={item.id} className="grid grid-cols-4 gap-4">
                                    <div className="col-span-1 text-right">
                ...
                {visibleSections.includes('awards') && awards && awards.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Awards</h2>
                ...
                {skills.length > 0 && (
                     <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Skills</h2>
                ...
                {visibleSections.includes('certifications') && certifications.length > 0 && (
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Certifications</h2>
                ...
                {visibleSections.includes('languages') && languages.length > 0 && (
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider mb-4 border-b pb-1" style={{ color: accentColor, borderColor: '#eee' }}>Languages</h2>
                        <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs">
