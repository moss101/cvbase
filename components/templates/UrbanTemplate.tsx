        ...
        <div id={isCardPreview ? undefined : "resume-preview-urban"} className={`w-[794px] min-h-[1123px] h-auto bg-white relative ${fontSizeClass}`} style={{ fontFamily: fontFamily, color: darkGrey }}>
            ...
            <div className="p-[50px] pt-[60px] flex gap-[40px] min-h-full">
                ...
                <aside className="w-[220px] shrink-0 flex flex-col gap-[40px]">
                    ...
                    {education.length > 0 && (
                        <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-4" style={{ color: sectionHeaderColor }}>Education</h2>
                    ...
                    {/* Skills - Styled as Colored Tags */}
                    {skills.length > 0 && (
                        <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-4" style={{ color: sectionHeaderColor }}>Skills</h2>
                    ...
                    {visibleSections.includes('languages') && languages.length > 0 && (
                        <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-4" style={{ color: sectionHeaderColor }}>Languages</h2>
                     ...
                     {visibleSections.includes('certifications') && certifications.length > 0 && (
                        <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-4" style={{ color: sectionHeaderColor }}>Certifications</h2>
                ...
                <main className="flex-1 flex flex-col gap-[40px] relative pt-[10px]">
                    ...
                    {experience.length > 0 && (
                        <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Experience</h2>
                    ...
                    {visibleSections.includes('projects') && projects.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Projects</h2>
                    ...
                    {visibleSections.includes('trainings') && trainings.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Trainings</h2>
                    ...
                    {visibleSections.includes('publications') && publications.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Publications</h2>
                            <div className="flex flex-col gap-5">
                    ...
                    {visibleSections.includes('awards') && awards.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Awards</h2>
                            <div className="flex flex-col gap-5">
                                {awards.map(item => (
                                    <div key={item.id}>
                                        <div className="flex justify-between items-baseline mb-1">
                    ...
                    {visibleSections.includes('volunteer') && volunteer.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Volunteering</h2>
                            <div className="flex flex-col gap-5">
                                {volunteer.map(item => (
                                    <div key={item.id}>
                                        <div className="flex justify-between items-baseline mb-1">
                    ...
                    {visibleSections.includes('custom') && custom.length > 0 && (
                         <section>
                            <h2 className="text-[10px] font-normal tracking-[2px] uppercase mb-6" style={{ color: sectionHeaderColor }}>Additional</h2>
                            <div className="flex flex-col gap-5">
                                {custom.map(item => (
                                    <div key={item.id}>
                                        <div className="flex justify-between items-baseline mb-1">
